...
// Lombok generated setters (avoid @Data for entities; performance issues)
// @ToString(exclude = "password")  // Old way: don't print passwords in logs!
/**
 * JPA entity representing an application user, integrating with Spring Security
 * via UserDetails to support authentication and role-based authorization.
 */
public class User implements UserDetails {
    ...
    @ToString.Exclude
    // Precision (field level): Prevents passwords from being printed
